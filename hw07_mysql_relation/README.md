#### Node.js & type script: Домашнее задание 7 (evening)
...
Создайте новую базу данных с именем \`database\_development\`, которая будет использоваться для разработки вашего приложения.
...
* Укажите имя базы данных (\`database\_development\`).
